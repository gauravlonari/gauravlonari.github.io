...
export default function Nav(props) {
  ...
  return (
    <nav>
      ...
      <a href="#experience"  onClick={()=>{props.nav.setActiveNav('#positions')}} className={props.nav.activeNav==='#positions' || props.nav.activeNav==='#experience' ? 'active':''}><BsSignpostSplit/></a>
